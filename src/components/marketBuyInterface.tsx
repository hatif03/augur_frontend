...
import { predictionMarketContract, tokenContract } from "@/constants/contracts";
    ...
    const checkApproval = async () => {
        ...
        try {
            const userAllowance = await readContract({
                ...
                params: [account?.address as string, predictionMarketContract.address]
            });
    ...
    const handleSetApproval = async () => {
        ...
        try {
            const tx = await approve({
                contract: tokenContract,
                spender: predictionMarketContract.address,
                amount: amount
            });
